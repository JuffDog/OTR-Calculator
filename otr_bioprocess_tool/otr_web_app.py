...
MEDIUM_OSMOLALITIES = {
    ...
    "Generic cell culture medium — 0.301 osmol/kg": 0.301,
...
def orbit_input(label, key_prefix, default_choice="25 mm"):
...
def osmolality_input(label, key_prefix, default_choice="LB — 0.240 osmol/kg"):
...
with tab_calc:
    ...
    rpm_range = np.linspace(50, 400, 120)
