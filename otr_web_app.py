...
class MeierOTRModel:
    ...
    Units expected by the correlation:
    - OTRmax: mmol/L/h
    - Osmol: osmol/kg
    - n: rpm = 1/min
    - V_L: mL
    ...
    - d: mm
    - p_R: bar
    - y_O2: mole fraction, e.g. 0.2095 for air
    """
...
st.set_page_config(
    page_title="OTRmax Calculator — Meier et al. model",
    page_icon="🧪",
    layout="wide",
)
...
with st.expander("Model equation and units", expanded=True):
    st.markdown(
        """
